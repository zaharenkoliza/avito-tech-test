import { Box, Group, Paper, Select, TextInput, UnstyledButton } from '@mantine/core'
	...
	>
		<Group gap={12} wrap="nowrap" align="center">
			<TextInput
				...
				radius={8}
				rightSection={<IconSearch size={16} stroke={1.7} color="#666" />}
				styles={{
					input: {
						height: 36,
			...
			>
				...
				>
					<IconLayoutGrid size={16} color={layout === 'grid' ? '#2f8cff' : '#2f2f2f'} />
				</UnstyledButton>
				...
				>
					<IconList size={16} color={layout === 'list' ? '#2f8cff' : '#2f2f2f'} />
				</UnstyledButton>
			</Box>
